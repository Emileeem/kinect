...
static class Blur
{
    ...
    static unsafe void setInitial(byte* im, long* c, int channel)
        => *c = *(im + channel);
    ...
    static unsafe void setLine(byte* im, long* c, int channel, int width)
    {
        c++;
    ...
    static unsafe void setColumn(byte* im, long* c, int channel, int height, int width, int stride)
    {
        c += width;
    ...
    static unsafe void fill(byte* im, long* c, int channel, int height, int width, int stride)
    {
