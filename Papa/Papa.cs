...
namespace Papa
{
    public class Plano
    {
        ...
        public (float a, float b, float c) CalcularVetor((float x, float y, float z) p, (float x, float y, float z) q)
        {
        ...
        public (float a, float b, float c) CalcularPontoMedio((float x, float y, float z) p, (float x, float y, float z) q)
        {
        ...
        public (float a, float b, float c, float d) CalcularPlano((float x, float y, float z) p, (float x, float y, float z) q)
        {
